...
//        fun onGetUserTransactionSuccess(data: List<Historical.DataTransaction>)
...
//        fun onGetTradeTransactionSuccess(data: List<Historical.DataTradeTransaction>)
...
//        fun onGetAllTransactionSuccess(data: List<Historical.AllTransactionData>)
