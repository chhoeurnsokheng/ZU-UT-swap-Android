...
import com.zillennium.utswap.databinding.DialogFinanceSwapBinding
import com.zillennium.utswap.utils.groupingSeparator
import eightbitlab.com.blurview.RenderScriptBlur

class FinanceLockUpSwapDialog: DialogFragment() {

    private var binding: DialogFinanceSwapBinding? = null
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.dialog_finance_swap, container, false)
        return binding?.root
    }
    ...
    companion object {
        fun newInstance(
            ...
            endDate: String?,
            duration: String?,
        ): FinanceLockUpSwapDialog {
            val financeLockUpSwapDialog = FinanceLockUpSwapDialog()
            val args = Bundle()
            ...
            financeLockUpSwapDialog.arguments = args
            return financeLockUpSwapDialog
        }
    }
}