...
import com.zillennium.utswap.databinding.ActivityChangeProfileCameraBinding
...
class ChangeProfileCameraActivity  :
    BaseMvpActivity<ChangeProfileCameraView.View, ChangeProfileCameraView.Presenter, ActivityChangeProfileCameraBinding>(),
    ChangeProfileCameraView.View {

    override var mPresenter: ChangeProfileCameraView.Presenter = ChangeProfileCameraPresenter()
    override val layoutResource: Int = R.layout.activity_change_profile_camera
