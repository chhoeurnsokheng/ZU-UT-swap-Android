...
import com.zillennium.utswap.screens.security.securityFragment.PromptScreen.PromptFragment
...
class TermConditionFragment :
    ...
    override val layoutResource: Int = R.layout.fragment_security_term_condition
