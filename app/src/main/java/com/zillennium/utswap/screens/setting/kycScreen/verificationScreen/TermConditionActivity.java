...
import com.zillennium.utswap.screens.setting.kycScreen.idTypeScreen.IdTypeActivity;
...
public class TermConditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kyc_term_condition);
    ...
    public void initAction(){
        ...
        txtContent.setText("1. IMPORTANT & MUST READ\n" +
