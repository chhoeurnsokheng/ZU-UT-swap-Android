...
import com.zillennium.utswap.databinding.ActivityProjectIcoBinding
import java.io.IOException

class ProjectICOActivity :
    BaseMvpActivity<ProjectICOView.View, ProjectICOView.Presenter, ActivityProjectIcoBinding>(),
    ProjectICOView.View {

    override var mPresenter: ProjectICOView.Presenter = ProjectICOPresenter()
    override val layoutResource: Int = R.layout.activity_project_ico
    ...
    override fun initView() {
        ...
        try {
            binding.apply {
                ...
                val projectArrayList = ArrayList<ProjectICO>()

                for (i in title.indices) {
                    val project = ProjectICO(title[i], desc[i], icon[i])
                ...
                recyclerView.adapter = ProjectICOAdapter(projectArrayList)
