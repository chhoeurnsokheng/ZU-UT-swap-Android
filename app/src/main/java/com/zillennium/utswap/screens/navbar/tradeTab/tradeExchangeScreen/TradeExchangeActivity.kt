        ...
        try {
            binding.apply {
                ...
                persistentBottomSheet.btnMarket.setOnClickListener {
                    ...
                    persistentBottomSheet.btnMarket.backgroundTintList = ColorStateList.valueOf(ContextCompat.getColor(UTSwapApp.instance, R.color.color_main))
                    persistentBottomSheet.txtMarket.setTextColor(ContextCompat.getColor(UTSwapApp.instance, R.color.white))
                    persistentBottomSheet.txtLimit.setTextColor(ContextCompat.getColor(UTSwapApp.instance, R.color.color_main))
                ...
                persistentBottomSheet.btnLimit.setOnClickListener {
                    ...
                    persistentBottomSheet.btnLimit.backgroundTintList = ColorStateList.valueOf(ContextCompat.getColor(UTSwapApp.instance, R.color.color_main))
                    persistentBottomSheet.txtLimit.setTextColor(ContextCompat.getColor(UTSwapApp.instance, R.color.white))
                    persistentBottomSheet.txtMarket.setTextColor(ContextCompat.getColor(UTSwapApp.instance, R.color.color_main))
