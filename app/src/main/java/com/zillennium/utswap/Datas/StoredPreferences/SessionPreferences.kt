...
class SessionPreferences: BaseStoredPreferences(UTSwapApp.instance, "SessionPreferences") {
    ...
    var SESSION_ID by stringPref(defaultValue = "535")
    ...
    var SESSION_KYC_SUBMIT_STATUS by booleanPref(defaultValue = true)
    var SESSION_TOKEN by stringPref(defaultValue = "68cb2fb0ee69dfc69107bf22e794728f")
    var SESSION_EXPIRED by stringPref()
    var SESSION_X_TOKEN_API by stringPref()
